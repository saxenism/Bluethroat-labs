        ...
        <footer className="bg-background mt-16 border-y border-border">
            ...
            <div className="border-b border-border bg-zinc-50/50 dark:bg-zinc-950/50">
                <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row items-stretch border-border">
                    {/* Logo Section */}
                    <div className="flex items-center justify-center md:justify-start px-5 py-6 md:py-0 md:h-17 border-b md:border-b-0 md:border-r border-border group transition-colors">
                        <Link href="/" onClick={handleLogoClick} className="flex items-center space-x-3 group transition-colors">
                            <svg
                                width="32"
                                height="32"
                                viewBox="0 0 32 32"
                            ...
                            >
                                <path d="M12.9537 24.6352V18.3938C12.9537 17.8417 12.1938 17.6914 11.9836 18.2019L6.26586 31.3002C6.04623 31.8335 6.74966 32.2579 7.11908 31.8149L12.8368 24.958C12.9123 24.8674 12.9537 24.7532 12.9537 24.6352Z" fill="currentColor" />
                                <path d="M24.9186 12.5599L14.4527 23.5066C14.1386 23.8352 13.5844 23.6128 13.5844 23.1583V3.93387C13.5844 3.60636 13.8705 3.40137 14.1471 3.43177C14.3893 3.4584 14.5603 3.67398 14.7515 3.82515L24.6429 11.6484C24.8341 11.7996 25.0577 11.9664 25.0584 12.2101C25.0587 12.3362 25.012 12.4622 24.9186 12.5599Z" fill="currentColor" />
                                ...
                                <path d="M26.8631 2.58534L26.1492 11.086C26.1012 11.3657 25.8501 11.5248 25.6053 11.5033C25.3556 11.4812 25.1777 11.2596 24.9802 11.1053L18.3564 5.93505C18.1589 5.78084 17.9257 5.60934 17.9306 5.35876C17.9347 5.14616 18.0728 4.94175 18.3049 4.87982L26.2363 2.013C26.5914 1.91822 26.9253 2.22311 26.8631 2.58534Z" fill="currentColor" />
                                <path d="M27.1781 6.64015L27.4939 2.55609C27.5376 2.30726 27.7454 2.15071 27.9668 2.13941C28.2238 2.1263 28.4339 2.33071 28.6549 2.46259L31.4552 4.13396C31.6762 4.26584 31.9372 4.41225 31.9576 4.66876C31.9646 4.75641 31.9487 4.8449 31.9119 4.92449C31.7931 5.18159 31.4731 5.26132 31.2232 5.3946L28.1944 7.00999C27.9445 7.14326 27.6494 7.30578 27.409 7.15596C27.2439 7.05305 27.14 6.85711 27.1781 6.64015Z" fill="currentColor" />
                            </svg>
                            <span className="font-mono text-xl font-bold tracking-tight">Bluethroat Labs</span>
                        </Link>
                    </div>

                    {/* Navigation Links Section */}
                    <div className="flex flex-col md:flex-row flex-1 items-stretch md:items-center border-b md:border-b-0 md:border-r border-border">
                        <div className="flex flex-col md:flex-row flex-1 items-center justify-center md:justify-start px-8 py-8 md:py-0 space-y-6 md:space-y-0 md:space-x-10">
                            {navLinks.map((link) => (
                                <Link
                                    key={link.href}
                                    href={link.href}
                    ...
                    <div className="flex items-stretch justify-center h-16 md:h-auto">
                        <div className="flex-1 md:flex-none flex items-stretch border-r md:border-r-0 border-border">
                            <a
                                href="https://x.com/bluethroat_labs"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex-1 md:flex-none flex items-center justify-center px-8 md:px-5 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors border-r md:border-l border-border"
                            >
                        ...
                        <div className="flex-1 md:hidden bg-zinc-50 border-border" /> {/* Spacer for mockup layout match */}
                    </div>
                </div>
            </div>

            {/* Pattern Image Section */}
            <div className="h-64 sm:h-80 md:h-[400px] w-full relative overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                <div
