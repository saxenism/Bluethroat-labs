...
export function DocsFooter() {
  return (
    <footer className="border-border bg-background flex h-16 items-center justify-between border-t">
      ...
      <div className="flex flex-1 items-stretch md:flex-none">
        <a
          href="mailto:hello@bluethroat.ai"
          className="flex flex-1 items-center justify-center px-8 transition-colors hover:bg-zinc-100 md:flex-none md:px-2 dark:hover:bg-zinc-900"
        >
        ...
        <a
          ...
          className="flex flex-1 items-center justify-center px-8 transition-colors hover:bg-zinc-100 md:flex-none md:px-5 dark:hover:bg-zinc-900"
        >
          <svg
            className="text-foreground h-8 w-8 fill-current"
            viewBox="0 0 24 24"
          >
