  ...
  return (
    <footer className="bg-background border-border mt-17 border-y">
      ...
      <div className="relative mt-12 h-64 w-full overflow-hidden bg-[#f2f2f2] sm:h-80 md:h-[400px] dark:bg-[#191919]">
        <Image
          src="/images/footer-bg-light.png"
          alt="Footer"
          fill
          className="object-cover dark:hidden"
        />
        <Image
          src="/images/footer-bg-dark.png"
          alt="Footer"
          fill
      ...
      {/* Bottom Bar */}
      <div className="border-border text-foreground flex items-center justify-center border-t bg-[#f2f2f2] p-3 font-mono text-sm dark:bg-[#191919]">
