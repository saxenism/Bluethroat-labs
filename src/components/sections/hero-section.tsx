...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative grid place-items-center px-2 pt-10 pb-48 md:pt-18 md:pb-56">
        ...
        <div className="absolute bottom-0 left-0 z-30 mx-auto w-full max-w-[830px] bg-[#191919] p-4 sm:p-6 lg:p-12">
          <p className="text-base leading-relaxed font-semibold text-[#F2F2F2] sm:text-lg md:text-lg">
