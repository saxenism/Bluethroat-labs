  ...
  return (
    ...
    >
      ...
      <div className="p-4 pt-6 pb-12 md:p-12 md:pb-18">
        <p className="tex-[#292929] mb-6 text-base leading-relaxed md:mb-8 md:text-xl dark:text-[#E6E6E6]">
          Bluethroat Labs exists to accelerate the security maturity of Web3.
          Security cannot be solved with generic tools. Every domain has its own
          assumptions, attack surfaces, and failure modes that must be
        ...
        <p className="tex-[#292929] mt-10 text-base leading-relaxed md:text-xl dark:text-[#E6E6E6]">
