  ...
  return (
    <nav className="bg-background border-border fixed top-0 right-0 left-0 z-50 border-b">
      <div className="mx-auto flex h-16 items-center">
        {/* Logo Section */}
        <div className="border-border flex h-full min-w-[320px] items-center border-r px-4 md:px-4">
        ...
        {/* Navbar Links */}
        <div className="flex h-full flex-1 items-center gap-8 px-8">
          <Link
            href="/"
        ...
        <div className="border-border h-full border-l">
          <button
            onClick={toggleTheme}
            className="hover:bg-muted h-full px-4 transition-colors"
