...
export const MOCK_BLOGS = [
    {
        ...
        content: [
            ...
            },
            {
                _type: 'block',
                style: 'normal',
                children: [{ _type: 'span', text: 'Ok so continuing commentary on TEE attacks from my previous article on TEE.fail attack...' }]
            }
        ]
    },
    {
    ...
    "executive-summary": {
        ...
        content: [
            ...
            },
            {
                ...
                _type: 'block',
                style: 'normal',
                children: [{ _type: 'span', text: 'Bluethroat Labs is pioneering the next generation of confidential computing infrastructure.' }]
            }
        ],
