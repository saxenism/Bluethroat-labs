...
export const DOCS_NAVIGATION: DocNavItem[] = [
    ...
    { title: 'Backdrop What are TEES and adjacent technologies?', slug: 'backdrop' },
    { title: 'TEES in Web3', slug: 'tees-in-web3' },
    {
        ...
        items: [
            { title: 'AWS Nitro System', slug: 'platform-profiles/aws-nitro-system' },
            {
                ...
                items: [
                    { title: 'AWS Nitro Threat Vectors [PARANOID]', slug: 'platform-profiles/aws-nitro-enclaves/threat-vectors' }
                ]
            },
            { title: 'Dstack - Decentralized Cloud TEEs', slug: 'platform-profiles/dstack' }
        ]
    },
    { title: 'TEE attacks categorisation', slug: 'attacks' },
    { title: 'Dumb ways to get rekt w/ TEES', slug: 'rekt' },
    { title: 'Layers of security for protocols building with TEES', slug: 'security-layers' },
...
export const DOCS_DATA: Record<string, DocPageData> = {
    ...
    'expectations': {
        ...
        next: { title: 'Backdrop What are TEES and adjacent technologies?', slug: 'backdrop' },
    ...
    'platform-profiles/aws-nitro-system': {
        ...
        `,
        subSections: [
            { id: 'architecture', title: 'Nitro Architecture' }
        ],
        prev: { title: 'TEES in Web3', slug: 'tees-in-web3' },
        next: { title: 'AWS Nitro Enclaves', slug: 'platform-profiles/aws-nitro-enclaves' },
